...
#finetune
python3 train.py --config-name=train_pilot_finetune training.fine_tune.model=pidiff_bsz128_c1_ac1_gcTrue_gcp0.5_ph16_tceTrue_ntmaxmin_2024-11-16_09-39-09
python3 train.py --config-name=train_pilot_finetune training.fine_tune.model=pidiff_bsz128_c1_ac1_gcTrue_gcp0.5_ah16_ph16_tceTrue_ntmaxmin_2024-11-17_08-56-34