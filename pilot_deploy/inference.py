...
from pilot_deploy.utils import (tic, toc, unnormalize_data,
                    to_numpy,
                    transform_images,
                    get_delta,
                    calculate_sin_cos)
...
from pilot_config.config import get_inference_model_config
...
def main():
    ...
    model = InferenceModel(data_cfg=data_cfg,
